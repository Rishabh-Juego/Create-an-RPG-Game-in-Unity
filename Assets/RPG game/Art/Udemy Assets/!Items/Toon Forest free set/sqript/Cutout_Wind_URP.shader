Shader "Custom/Cutout_Wind_URP"
{
    ...
    SubShader
    {
        ...
        LOD 200
        Cull Off // Standard for foliage, though not in your original, it's usually needed
        ...
        Pass
        {
            ...
            struct Attributes {
                ...
                float2 uv : TEXCOORD0;
                float4 color : COLOR; // Wind variation data
            ...
            Varyings vert (Attributes v) {
                ...
                float4 waves = v.positionOS.x * _waveXSize;
                waves += v.positionOS.z * _waveZSize;
                ...
                float waveAmount = v.uv.y * (v.color.a + _ShakeBending);
                s *= waveAmount;
        ...
        // Shadow Pass also needs the vertex wind logic so the shadow wiggles too
